...
DEFINE_SYSCALL(35, SYS_A08C);
DEFINE_SYSCALL(36, SYS_A090);
DEFINE_SYSCALL(37, SYS_A094);
DEFINE_SYSCALL(38, SYS_A098);
DEFINE_SYSCALL(39, IsKeyReady);
DEFINE_SYSCALL(40, SYS_A0A0);
DEFINE_SYSCALL(41, SYS_A0A4);
DEFINE_SYSCALL(42, SYS_A0A8);
DEFINE_SYSCALL(43, SYS_A0AC);
...
DEFINE_SYSCALL(60, SYS_A0F0);
DEFINE_SYSCALL(61, SYS_A0F4);
DEFINE_SYSCALL(62, SYS_A0F8);
DEFINE_SYSCALL(63, SYS_A0FC);
DEFINE_SYSCALL(64, SYS_A100); // dialog show
DEFINE_SYSCALL(65, SYS_A104); // dialog event loop
DEFINE_SYSCALL(66, SYS_A108);
DEFINE_SYSCALL(67, SYS_A10C);
DEFINE_SYSCALL(68, SYS_A110);
...
DEFINE_SYSCALL(142, SYS_A238); // get applet index
DEFINE_SYSCALL(143, SYS_A23C);
DEFINE_SYSCALL(144, SYS_A240);
DEFINE_SYSCALL(145, SYS_A244);
