...
DEFINE_SYSCALL(0xA018, SYS_A018); // set cursor mode
DEFINE_SYSCALL(0xA01C, SYS_A01C); // get cursor mode
DEFINE_SYSCALL(0xA020, SYS_A020); // clear rows & cols
DEFINE_SYSCALL(0xA024, SYS_A024); // clear rows
...
DEFINE_SYSCALL(0xA048, SYS_A048); // draw bitmap
DEFINE_SYSCALL(0xA04C, SYS_A04C); // draw pattern
...
DEFINE_SYSCALL(0xA080, SYS_A080); // progress bar
